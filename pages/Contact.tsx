  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 space-y-12">
        ...
        <div
          id="secure-form"
          className="bg-slate-800 p-8 rounded-lg shadow-lg border border-slate-700 text-white relative overflow-hidden"
        >
          ...
          <form className="space-y-4 relative z-10">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 py-2 bg-slate-900 border border-slate-600 rounded-md focus:ring-red-500 focus:border-red-500 text-white"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-1">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-center pt-8">
          <div className="p-4 bg-white rounded border border-slate-200">
            ...
            <a
              href="mailto:brussels@migrant88.com"
              className="text-sm text-red-600 hover:underline block mt-2"
            >
              brussels@migrant88.com
            </a>
          </div>
          <div className="p-4 bg-white rounded border border-slate-200">
          ...
          <div className="p-4 bg-white rounded border border-slate-200">
            ...
            <a
              href="mailto:dhaka@migrant88.com"
              className="text-sm text-red-600 hover:underline block mt-2"
            >
              dhaka@migrant88.com
            </a>

    ...
    <footer className="bg-slate-900 dark:bg-slate-950 text-slate-300 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 animate-fade-in-up">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              Migrant88 is an independent investigative research organisation
              committed to transparency, accountability, and worker rights.
              Decoding Power. Demanding Justice.
            </p>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
          <p>
            &copy; {new Date().getFullYear()} Migrant88. All rights reserved.
          </p>
